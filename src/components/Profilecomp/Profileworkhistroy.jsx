...
export default function Profileworkhistroy({ width }) {
        ...
        {width > 700 ? (
          ...
          >
            ...
            <div
              style={{
                color: "#064C87",
                borderBottom: "0.5vw solid #064C87",
                width: "40vw",
            ...
            alljobindone?.map((data, index) => {
              return (
                <div className="workhistrybox">
                  <div className="workhistryboxtitle">   {data?.appliedForJobPost[0]?.jobPostId?.workTitle} (
                    {data?.appliedForJobPost[0]?.jobPostId?.trackingId})</div>
                  ...
                  <div
                    ...
                    dangerouslySetInnerHTML={{ __html: data?.appliedForJobPost[0]?.jobPostId?.shortDescription }}
                  >
        ...
        <div style={{ margin: "2vw 2vw" }}>
          {alljobingoing?.length > 0 ? (
            ...
            <div className="workhistoryemptyhint" style={{ color: "#7a7575" }}>
              ...
              <Link to="/dashbaord/addApplyWork">
                {" "}
                <u style={{ color: "#6e6eb9" }}>Click here</u>{" "}
              </Link>{" "}
              &nbsp;&nbsp;{width > 700 ? "to redirect Browse a Job." : ""}
            </div>
          )}
        </div>
      ) : (
