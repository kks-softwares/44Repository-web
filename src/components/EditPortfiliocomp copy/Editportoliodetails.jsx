...
export default function Editportoliodetails({ width }) {
  useEffect(() => {
  ...
  return (
    <div className="addpfcontaineradd">
      ...
      {/* ==============OLD SKill Update Set ENTER key================= */}
          ...
          {skillset?.map((skill, index) => {
            return (
              ...
              >
                ...
                <div
                  onClick={() => {
                    axios.post(`${API_HOST}/portfolio/removeSkills`, {
        ...
        <div style={{ display: "flex" }}>
          <input
            ...
            onKeyPress={(e) => {
              if (e.key === "Enter") {
                e.preventDefault();
                axios.post(`${API_HOST}/portfolio/updateSkills`, {
                  projectPortfolioId: id,
                  skills: [...skillset, skilltext],
                });
      ...
      >
        <TextField
          ...
          placeholder="Loremying out print, graphic or web designs. The passage is attributed to an unknown typesetter in the 15th century who is thought to have scrambled parts of Cicero's De Finibus Bonorum et Malorum for use in a type specimen book. It usually begins with:"
          multiline
          rows="8"
          style={{ width: "100%" }}
          InputLabelProps={{
      ...
      >
        ...
        <Link to={`/updateportfolio/${id}/preview`}>
          <div
            style={{
              cursor: "pointer",
