...
export default function Addblog({ width }) {
  ...
  const handlesumbitBlog = () => {
    ...
    axios
      .post(`${API_HOST}/contentManagement/addcontent`, formdata, {
        headers: {
      ...
      >
        ...
        >
          ...
          <div>
            ...
            <div className="jobpodtedfieldtitile mt-3"> Image Title *</div>
            <div className="jobpostfieldinputbox">
              {/* <input
                type="text"
                value={imagetitle}
            ...
            <div className="jobpodtedfieldtitile mt-3">META TAG *</div>
            <div className="jobpostfieldinputbox">
              {/* <input
                type="text"
                value={metaTag}
            ...
            <div className="jobpodtedfieldtitile mt-3">META TITLE *</div>
            <div className="jobpostfieldinputbox">
            {/* <input
                  type="text"
                  value={metaTitle}
            ...
            <div className="jobpodtedfieldtitile mt-3">META DESCRIPTION *</div>
            <div className="jobpostfieldinputbox">
            {/* <input
                  type="text"
        ...
        <Box sx={width > 700 ? style : style1}>
          ...
          >
            ...
            <div
              ...
              className="widthfullblofpreview"
            >
              {arrayofblogs?.length > 0 &&
                arrayofblogs?.map((data, index) => {
                  return (
                    <div>
                      ...
                      >
                        ...
                        >
                          ...
                          <div className="Joinwithusblogboxdetail" style={{color:'white'}} dangerouslySetInnerHTML={{ __html: data?.desc?.slice(0, 200) }}>
