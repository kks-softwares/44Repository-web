...
export default function CreateWork({ width }) {
  ...
  useEffect(() => {
    if (user?.userName) {
      axios
        .get(
          `${API_HOST}/jobPost/jobPostedByUsers?userName=${
            user?.userName
  ...
  return (
    <div className="BrowseWorkMain-cntainer">
      ...
      >
        ...
        <div
          style={{
            width: width > 700 ? "5vw" : "7vw",
            height: width > 700 ? "1vw" : "5vw",
            paddingTop: "2vw",
          }}
        >
          <img
            ...
            style={{
              margin: width > 700 ? "0vw 0.5vw" : "2vw 1vw",
              marginRight: width > 700 ? "3vw" : "4vw",
              width: width > 700 ? "2vw " : "5.5vw",
              height: width > 700 ? "2vw" : "5.5vw",
              borderRadius: "50%",
              cursor: "pointer",
              objectFit: "cover",
            }}
