...
export default function Jobdetail1({ jobdetail, width }) {
  ...
  const handleendContarct = () => {
    ...
    formdata.append("assignedJobComplitionDate", date);
    formdata.append("reviews", review);
    formdata.append("ratings", starclient);
    formdata.append("assignedJobComplition", true);
    formdata.append("workStatus", "Completed");
    formdata.append("closeBy44", false);
    formdata.append("bidingId", data1?.workAssignedTo?.bidingId);

    axios.post(`${API_HOST}/biding/submitReview`, formdata, {}).then((res) => {
      axios
    ...
    <div>
      ...
      >
        ...
        >
          ...
          {data1?.jobDoerId?.userName === user?.userName ? (
            <div>
              {data1?.closeBy44 ? (
                <div>
                  Status :{" "}
                  ...
                  {data1?.workAssignedTo?.assignedJobComplition &&
                    !data1?.assignWorkComplition && (
                      <div>
                        Status :{" "}
                        <span style={{ color: "green", marginRight: "1vw" }}>
                          Waiting for Client For End Contract
                        </span>
                      </div>
                    )}
                  {data1?.workAssignedTo?.assignedJobComplition &&
                    data1?.assignWorkComplition && (
                      <div>
                        Status :{" "}
                        <span style={{ color: "green", marginRight: "1vw" }}>
                          Contract Ended by You and Client
                        </span>
                      </div>
                    )}
                  {!data1?.workAssignedTo?.assignedJobComplition &&
            ...
            <div>
              ...
              Work assigned to other service provider
              </span>
            </div>
          )}
        </div>
        ...
        <div
          style={{
            height: down1
              ? `${(width > 700 ? 4 : 12) + (width > 700 ? 7 : 12)}vw`
              : "",
          }}
          className="boxofextension"
        >
            ...
            <div hidden={!down4}>
              ...
              >
                <div className="boxblackbackg">
                  ...
                  <div>
                    <span>
                      {data1?.workAssignedTo?.assignedJobComplitionDate
                        ? data1?.workAssignedTo?.assignedJobComplitionDate
                        : "-"}
                    </span>
                  </div>
                  ...
                  <div className="workhistryboxdate">
                    ...
                    >
                      <StarRatings
                        ...
                        name="rating"
                        changeRating={(e) => {
                          if (!data1?.workAssignedTo?.ratings) {
                            setStarclient(e);
                            setSetratingerror("");
                          }
                        }}
                  ...
                  >
                    ...
                    <div>
                      <textarea
                        ...
                        onChange={(e) => {
                          if (!data1?.workAssignedTo?.reviews) {
        ...
        >
          <Box sx={width > 700 ? style1 : style2}>
            ...
            <div style={{ left: "0vw", width: "100%" }} className="loginfield">
              The Action Will End Contract "{data1?.workTitle}" . Are You Sure
              Want to End Contact With the Client "{data1?.user_id?.fullName}" ?
            </div>
