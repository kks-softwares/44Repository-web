...
export default function AddJob({ handleClose, width }) {
  ...
  const handlePostJOb = () => {
    ...
    axios
      .post(`${API_HOST}/jobPost/addJobPost`, formdata, {
        headers: {
        ...
        <div>
          ...
          <div
            style={{
              marginBottom: "0.5vw",
              marginTop: "1.3vw",
              fontSize: width > 700 ? "1.2vw" : "3.1vw",
            }}
              ...
              <div className="jobpostfieldinputbox">
                <Box
                  sx={{
                    ...
                    width: "95%",
                    borderRadius: "5px",
                    padding: width > 700 ? "0.4vw" : "3vw 1vw",
          ...
          {cateaddcheckbox1 ? (
            <div>
              <div
                style={{ left: "0vw", width:width>700? "41vw":"100%", marginLeft: "0" }}
                className="loginfield"
              ...
              >
                <div style={{ maxHeight: width>700?"18vw":"40vw", overflow: "scroll" ,width:width>700?"":"100%" }}>
                  <Typography
                    sx={{
                      p: 1,
                      pl: 1,
                      ml: 1,
                      width:width>700? "40vw":"88vw",
                      position: "fixed",
                      background: "white",
                      zIndex: "10",
                    }}
          ...
          <div className="imgboxofrewardpostlogo">
            ...
            <span>
              ...
              <CloseIcon
                style={{
                  position: "relative",
                  left: width>700? "23vw":"40vw",
                  bottom: width>700?"22vw":"54vw",
                  fontSize: width>700?  "1.5vw":"5vw",
                  cursor: "pointer",
                }}
